...
/***/ function(module, exports, __webpack_require__) {
	...
	var _counter = __webpack_require__(210);
	...
	function render() {
		...
		_riot2.default.mount('*', { store: store });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _visibility = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(23);
	$export($export.S, 'Object', {is: __webpack_require__(63)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(69)('getOwnPropertyNames', function(){
	  return __webpack_require__(57).get;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setDesc    = __webpack_require__(22).setDesc
	  , createDesc = __webpack_require__(27)
	  , has        = __webpack_require__(37)
	  ...
	  , NAME       = 'name';
	// 19.2.4.2 name
	NAME in FProto || __webpack_require__(28) && setDesc(FProto, NAME, {
	  configurable: true,
	  get: function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')){
	  ...
	  $.each.call(__webpack_require__(28) ? $.getNames(Base) : (
	    // ES3:
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S, 'Math', {expm1: __webpack_require__(103)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(26)(IteratorPrototype, __webpack_require__(51)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 21.2.5.3 get RegExp.prototype.flags()
	var $ = __webpack_require__(22);
	if(__webpack_require__(28) && /./g.flags != 'g')$.setDesc(RegExp.prototype, 'flags', {
	  configurable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@match logic
	__webpack_require__(152)('match', 1, function(defined, MATCH){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@search logic
	__webpack_require__(152)('search', 1, function(defined, SEARCH){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(22)
	  ...
	  , anObject   = __webpack_require__(40)
	  , aFunction  = __webpack_require__(33)
	  , strictNew  = __webpack_require__(157)
	...
	if(!USE_NATIVE){
	  ...
	  __webpack_require__(162)(P.prototype, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $WeakMap = __webpack_require__(165)('WeakMap', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export  = __webpack_require__(23)
	  , getDesc  = __webpack_require__(22).getDesc
	  , anObject = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P, 'Map', {toJSON: __webpack_require__(199)('Map')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P, 'Set', {toJSON: __webpack_require__(199)('Set')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('root', '<counter store="{opts.store}" state="{opts.store.getState().counter}"></counter> <div> Show: <filterlink store="{opts.store}" text="SHOW_ALL"></filterlink>&nbsp; <filterlink store="{opts.store}" text="SHOW_COMPLETED"></filterlink>&nbsp; <filterlink store="{opts.store}" text="SHOW_ACTIVE"></filterlink> </div> <todos store="{opts.store}" todos="{opts.store.getState().todos}" filter="{opts.store.getState().visibility}"></todos>', '', '', function (opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('counter', '<label>Counter: {counter}</label> <br> <button onclick="{increment}">+</button> <button onclick="{decrement}">-</button>', '', '', function (opts) {
		var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('todos', '<div> <form onsubmit="{add}"> <input name="todo"> <button type="submit">Add</button> </form> <ul> <li each="{display}" class="{completed: completed}"> <input type="checkbox" __checked="{completed}" onclick="{parent.completeClick}"> {text} </li> </ul> </div>', '', '', function (opts) {
		var _this = this;
	
		this.add = function (event) {
			opts.store.dispatch({
				type: 'ADD_TODO',
				text: _this.todo.value,
				id: _this.nextTodoId++
			});
			_this.todo.value = '';
		};
	
		this.completeClick = function (event) {
			opts.store.dispatch({
				type: 'TOGGLE_TODO',
				id: event.item.id
			});
		...
		this.render = function () {
			_this.display = _this.getVisibleTodos(opts.todos, opts.filter);
		};
		...
		this.getVisibleTodos = function (todos, filter) {
			switch (filter) {
				case 'SHOW_ALL':
					return todos;
				case 'SHOW_COMPLETED':
		...
		this.on('mount', function () {
			_this.nextTodoId = 0;
			opts.store.subscribe(_this.render);
			_this.render();
		});
	}, '{ }');
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('filterlink', '<a class="{disabled: isDisabled}" href="#" onclick="{click}"> {opts.text} </a>', '.disabled { pointer-events: none; cursor: default; text-decoration: none; font-weight: bold; }', '', function (opts) {
		var _this = this;
		...
		this.render = function () {
			_this.isDisabled = opts.text == opts.store.getState().visibility;
		};
